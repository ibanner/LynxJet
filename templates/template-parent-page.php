...
if ( have_posts() ) :
	while ( have_posts() ) : the_post();
		...
		<section id="content" class="parent-page">
			...
			<div class="container">
				<div class="row">
					<div id="child-pages-list" class="col-md-12 entry-content">
						<div class="image-box style10 block">
						...
						<article class="box">
							<figure>
								<a href="<?php echo get_permalink($pageChild->ID); ?>" rel="bookmark" title="<?php echo $pageChild->post_title; ?>" class="hover-effect">
									<?php echo get_the_post_thumbnail($pageChild->ID, 'strip' ); ?>
								</a>
							</figure>
