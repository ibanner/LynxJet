					...
					<div id="main" class="col-sm-8 col-md-9">
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<div class="details<?php echo ( empty( $isv_setting ) || ( $isv_setting == 'no' ) )?' without-featured-item':''; ?>">
								<div class="h1 entry-title"><?php the_title();?></div>
								...
								<div class="post-meta">
									...
									<div class="entry-author fn">
										<i class="icon soap-icon-user"></i> <?php esc_html_e( 'Posted By', 'lynxjet' ); ?>:
							...
							<div class="single-navigation block">
								<div class="row">
									...
									<?php if ( ! empty( $prev_post ) ): ?>
										<div class="col-xs-6"><a rel="prev" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" class="button btn-large prev full-width"><i class="soap-icon-longarrow-left"></i><span><?php _e( 'Previous Post', 'lynxjet' ) ?></span></a></div>
									<?php endif; ?>
									<?php $next_post = get_next_post(); ?>
									<?php if ( ! empty( $next_post ) ): ?>
										<div class="col-xs-6<?php if ( empty($prev_post) ) echo ' col-xs-offset-6'; ?>"><a rel="next" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" class="button btn-large next full-width"><span><?php _e( 'Next Post', 'lynxjet' ) ?></span><i class="soap-icon-longarrow-right"></i></a></div>
									<?php endif; ?>
								</div>
							</div>
							<div class="about-author block">
								<h2><?php _e( 'About Author', 'lynxjet' ) ?></h2>
								<div class="about-author-container">
									...
									<div class="about-author-meta clearfix">
										...
										<div class="wrote-posts-count"><i class="soap-icon-slider"></i><span><b><?php the_author_posts() ?></b> <?php _e( 'Posts', 'lynxjet' );?></span></div>
									</div>
								</div>
							</div>
							<h2><?php _e( 'You Might Also Like This', 'lynxjet' ); ?></h2>
